...
public class TestTableDao extends AbstractDao<TestTable, Long> {
    ...
    */
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, TestTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TestTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(TestTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
