...
public class ActivityDao extends AbstractDao<Activity, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Haha = new Property(4, String.class, "haha", false, "HAHA");
    };
    ...
    public Activity readEntity(Cursor cursor, int offset) {
        Activity entity = new Activity( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4) // haha
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Activity entity, int offset) {
        ...
        entity.setHaha(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
     }
